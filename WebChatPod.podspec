...
TODO: Add long description of the pod here.
 ...
 # s.user_target_xcconfig = {
  ...
  s.resources = [
    ...
    "WebChatPod/Classes/evawebchat/assets/eva/images/*png",
    "WebChatPod/Classes/evawebchat/assets/eva/js/*js",
    "WebChatPod/Classes/evawebchat/assets/icon/*png",
    "WebChatPod/Classes/evawebchat/assets/images/*svg",
    "WebChatPod/Classes/evawebchat/assets/*svg",
    "WebChatPod/Classes/evawebchat/im/*.{scxml,xsd,xml}",
