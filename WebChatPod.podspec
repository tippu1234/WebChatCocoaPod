...
TODO: Add long description of the pod here.
 ...
 # s.user_target_xcconfig = {
  ...
  s.resources = [
    ...
    "WebChatPod/Classes/**/assets/eva/images/*.png",
    "WebChatPod/Classes/**/assets/eva/js/*.js",
    "WebChatPod/Classes/**/assets/icon/*.png",
    "WebChatPod/Classes/**/assets/images/*.svg",
    "WebChatPod/Classes/**/assets/*.svg",
    "WebChatPod/Classes/**/im/*.{scxml,xsd,xml}",
    "WebChatPod/Classes/**/svg/*.svg",
